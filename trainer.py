...
class Trainer():
    ...
    def make_model_env(self, gpu, ngpus_per_node):
        ...
        self.lr_scheduler = get_scheduler("linear",
                                          ...
                                          num_warmup_steps=self.args.num_warmup_steps * self.args.num_epochs * len(self.train_loader),
    ...
    def train(self, model_path=None):
        ...
        for epoch in range(1, self.args.num_epochs+1):
            ...
            for batch_idx, batch in enumerate(self.train_loader, start=1):
                ...
                msg = "{}/{} {} - ETA : {} - nll: {:.4f}, triplet loss: {:.4f}".format(
                    batch_idx, batch_nb,
    ...
    def evaluate(self, msg):
        ...
        score = self.rouge.compute(rouge_types=['rouge1','rouge2','rougeL'])
        val_loss = np.mean(val_losses)

        return val_loss, score['rouge1'][1][2], score['rouge2'][1][2], score['rougeL'][1][2]
    
    
    def save_model(self, loss, epoch):
        model_to_save = self.model.module if hasattr(self.model, "module") else self.model
        ckpt = {"args":self.args,
                "state_dict":model_to_save.model.state_dict()}
